...
三个板块发布的内容互不交叉，首页内容为生活见闻；碎碎念内容为简单的感想、随笔，篇幅较短，类似于朋友圈，QQ空间；技术栈内容为技术类文章和学习笔记。
rss订阅包含首页和技术栈的内容，不包括碎碎念的内容。

## 网站开发
网站使用AI开发，而我的前端能力有限，如果建站工具和框架就没办法审查代码，所以只使用了html,css,js三件套。
考虑到网站访客大多是熟人，所以没有做评论、留言等功能。外来访客的留言信息可以直接发到我的邮箱中。
